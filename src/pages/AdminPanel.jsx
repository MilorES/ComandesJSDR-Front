                ...
                <tr key={p.id} className="border-b hover:bg-gray-100 transition-colors">
                  ...
                  <td className="py-3 px-4 text-center">
                    <div className="flex justify-center gap-3">
                      <button onClick={() => openModal("edit", p)} className="text-yellow-500 hover:text-yellow-400" title="Editar"><EditIcon></EditIcon></button>
                      <button onClick={() => openModal("delete", p)} className="text-red-600 hover:text-red-500" title="Eliminar"><DeleteIcon></DeleteIcon></button>
                    </div>
                  </td>
                </tr>
              ))}
            ...
            {products.map((p) => (
              <div key={p.id} className="p-4">
                ...
                <div className="flex justify-end gap-3 mt-2">
                  <button onClick={() => openModal("edit", p)} className="text-yellow-500 hover:text-yellow-400"><EditIcon></EditIcon></button>
                  <button onClick={() => openModal("delete", p)} className="text-red-600 hover:text-red-500"><DeleteIcon></DeleteIcon></button>
                </div>
              </div>
            ))}
          </div>
